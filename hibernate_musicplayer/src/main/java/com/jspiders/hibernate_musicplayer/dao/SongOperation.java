package com.jspiders.hibernate_musicplayer.dao;
...
import com.jspiders.hibernate_musicplayer.dto.Song;
...
public class SongOperation {
	...
	public int numberOfSongs() {
		...
		List<Song> songsList = creatQuery.getResultList();
...
//				System.out.println(songsList.get(i).getName());
		...
		if (numberOfSongs() > 0) {
			...
			for (int i = 1; i <= numberOfSongs(); i++) {
				...
				if (random <= numberOfSongs() && random != 0) {
					songs = entityManager.find(Song.class, random);
	...
	public void selectSong() {
		...
		if (numberOfSongs() > 0) {
			...
			songs = entityManager.find(Song.class, choise);
			System.out.println("Now " + songs.getName() + " Song Playing....");
			System.out.println("Zingg...");
			try {
				Thread.sleep(2000);
	...
	public void editSong() {
		...
		if (numberOfSongs() > 0) {
			...
			songs = entityManager.find(Song.class, scanner.nextInt());// choosing Song for delete
